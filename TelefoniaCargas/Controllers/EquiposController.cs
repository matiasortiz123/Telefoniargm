...
namespace TelefoniaCargas.Controllers
{
    public class EquiposController : Controller
    {
        ...
        {
            var equipo = await _context.Equipo.Include(u => u.Marca).Include(u => u.Empresa).Include(m => m.Modelo).Include(u => u.EstadoEquipo).Include(u=> u.Persona_Dependencia).ToListAsync();
            return View(equipo);
        }
